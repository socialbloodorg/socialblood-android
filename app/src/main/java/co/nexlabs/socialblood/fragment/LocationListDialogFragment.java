 ...
 */
public class LocationListDialogFragment extends DialogFragment implements
    ...
    public static LocationListDialogFragment getInstance() {
        LocationListDialogFragment fragment = new LocationListDialogFragment();

        return fragment;
    }

    public void setOnSelectListener(LocationListDialogFragment.OnSelectListener onSelectListener) {
        OnSelectListener = onSelectListener;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                OnSelectListener.onSelect(locationList.get(position));
                dismiss();
            }
        });
                        ...
                        .setResultCallback(new ResultCallback<PlaceBuffer>() {
                            ...
                            public void onResult(PlaceBuffer places) {
                                if (places.getStatus().isSuccess()) {
                                    ...
                                    location.setLatitude(myPlace.getLatLng().latitude);
                                    location.setLongitude(myPlace.getLatLng().longitude);
                                    location.setName(myPlace.getName().toString());
